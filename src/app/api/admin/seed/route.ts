  ...
  try {
    ...
    await prisma.galleryImage.createMany({
      data: [
        ...
        { url: "https://images.unsplash.com/photo-1547592180?w=800&q=80", caption: "Traditional Moroccan Breakfast", category: GalleryCategory.FOOD, sortOrder: 10 },
